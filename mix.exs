defmodule Lab42Message.MixProject do
  use Mix.Project
  ...
  defp package do
    [
      ...
      links: %{
        "GitHub" => "https://github.com/robertdober/lab42_message"
      }
    ]
  end
  ...
  defp build_docs(_) do
    ...
    args = ["Lab42.Message", @version, Mix.Project.compile_path()]
    opts = ~w[--main Lab42.Message --source-ref v#{@version} --source-url #{@url}]
